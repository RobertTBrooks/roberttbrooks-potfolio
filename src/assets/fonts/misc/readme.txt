...
True Type Font: Post Pixel-7 version 1.0


EULA
-==-
The font Post Post-7 is freeware for home using only.


DESCRIPTION
-=========-
Original pixel font. Capital and lower case letters have the same width: 9 and 7 pixels. Latin and Cyrillic code pages are supported.

Files in post_pixel-7.zip:
       	readme.txt     			this file;
        post_pixel-7.ttf    		regular font;
	post_pixel-7_screen.png		preview image.
